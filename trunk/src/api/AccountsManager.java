...
public class AccountsManager {
    ...
    public  boolean registerNewUser(String jmeno, String prijmeni, String email, char [] pole) throws RegisterOrganizerException {
...
DatabaseManager.saveAdresar(adresar);
            ...
            int idAdresare = adresar.getId();
                System.out.println("id adresare je "+idAdresare );
...
//                System.out.println("ID JE "+polozka.getId());
            ...
            throw new RegisterOrganizerException("Tento email je již v systému použit");
        }

...
public class MainWindow extends javax.swing.JFrame {
    ...
    public MainWindow(int id, String name, String lastname, String email) {
        ...
        //     createBussinessCard(hlavniPanel);
        // setButtonLabels();
    }
...
String labels = DatabaseManager.getUserLabels(this.userID);
       ...
       JCheckBox box = new JCheckBox("Položky bez štítku");
...
//
       if(this.pismeno!=null && this.pismeno!=""){
...
//        p.setMaximumSize(new java.awt.Dimension(330, pocetRadku*70));
//        p.setMinimumSize(new java.awt.Dimension(330, pocetRadku*70));
//        p.setPreferredSize(new java.awt.Dimension(330, pocetRadku*70));
            if (pocetRadku < 8) {
                pocetRadku = 8;
            }
    ...
    private void initComponents() {
        ...
        levyPanel.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Adresář", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 11), new java.awt.Color(0, 0, 255))); // NOI18N
        ...
        jLabel1.setText("Testovaci verze");
        ...
        jButton27.setText("Přidat kontakt");
        ...
        jMenuItem1.setText("Export do XML");
        ...
        jMenuItem2.setText("Export do HTML");
        ...
        jMenuItem3.setText("Export do TXT");
        jMenu1.add(jMenuItem3);

        jMenuItem4.setText("Export do CSV");
        jMenu1.add(jMenuItem4);

        jMenuItem5.setText("Export do Gmail");
        ...
        jMenuItem8.setText("Využití paměti");
        ...
        jMenu4.setText("Filtr zobrazení");
        jMenuBar1.add(jMenu4);

        jMenu5.setText("Akce");

        jMenuItem7.setText("Odstranit kontakty");
    ...
    private void openDeleteDialog(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_openDeleteDialog
        // TODO add your handling code here:
//        System.out.println("PUSTIM S "+this.userID);
...
//JPanel snaha = new JPanel();
        ...
        //    menuItem = new JMenuItem("Upravit položku");
        //menuItem.addActionListener(this);
        //  popup.add(menuItem);
        menuItem = new JMenuItem("Smazat položku");
    ...
    public void setNumberOfContacts() {
        ...
        jLabel3.setText("Celkem kontaktů: " + pocet);
    }

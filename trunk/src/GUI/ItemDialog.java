...
//        this.setAlwaysOnTop(false);
    ...
    private void initComponents() {
        ...
        jMenu1.setText("Kontakt");

        jMenuItem1.setText("Smazat");
        ...
        jMenu2.setText("Přidat detail");

        jMenuItem3.setText("Přidat adresu");
        ...
        jMenuItem4.setText("Přidat tel.číslo");
        ...
        jMenuItem5.setText("Přidat email");
        ...
        jMenuItem6.setText("Přidat IM kontakt");
        ...
        jMenuItem7.setText("Přidat URL adresu");
        ...
        jMenuItem8.setText("Přidat jiné");
...
//                pane2.setPreferredSize(new java.awt.Dimension(150, 40));
    ...
    private void addMenu(JTextArea area, int variant, ItemDialog iDiag, String type) {
        ...
        if (variant == 0) {
            ...
            menuItem = new JMenuItem("Upravit záznam");
            menuItem.setName(area.getName());
            menuItem.addActionListener(actionListener2);
            popup.add(menuItem);
            menuItem = new JMenuItem("Smazat záznam");
            menuItem.setName(area.getName());

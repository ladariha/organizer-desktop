...
public class GoogleExporDialog extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Export kontaktů do Gmailu");
        ...
        jPanel2.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Exportované kontakty:", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 11), new java.awt.Color(0, 0, 255))); // NOI18N

        jTextField2.setBorder(javax.swing.BorderFactory.createEtchedBorder());

        jRadioButton1.setBackground(new java.awt.Color(255, 255, 255));
        jRadioButton1.setSelected(true);
        jRadioButton1.setText("Přidat do skupiny \"Organizer\"");

        jRadioButton2.setBackground(new java.awt.Color(255, 255, 255));
        jRadioButton2.setText("Jiný název skupiny:");
        ...
        jTabbedPane1.addTab("Exportovat všechny kontakty", jPanel4);
        ...
        jTabbedPane1.addTab("Exportovat kontakty dle štítků", jPanel3);
        ...
        jTabbedPane1.addTab("Exportovat kontakty dle abecedy", jPanel5);
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        if(jmeno.length()!=0){
        InfoDialog id = new InfoDialog(new javax.swing.JFrame(), rootPaneCheckingEnabled, "Kontakty byly exportovány", "Exportované kontakty jsou ve skupině "+jmeno);
        id.setVisible(true);
        this.setVisible(false);
        }else{
        InfoDialog id = new InfoDialog(new javax.swing.JFrame(), rootPaneCheckingEnabled, "Kontakty nebyly exportovány", "Vyskytla se chyba exportu "+jmeno);
        id.setVisible(true);
        this.setVisible(false);
        }
        }else{

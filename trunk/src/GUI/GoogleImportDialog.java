...
public class GoogleImportDialog extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Import kontaktů z Gmailu");
        ...
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Importovaným kontaktům:", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 11), new java.awt.Color(0, 0, 255))); // NOI18N
        ...
        jRadioButton1.setText("Přidat štítek \"Gmail\"");

        jRadioButton2.setBackground(new java.awt.Color(255, 255, 255));
        buttonGroup1.add(jRadioButton2);
        jRadioButton2.setText("Přidat vlastní štítek");

        jRadioButton3.setBackground(new java.awt.Color(255, 255, 255));
        buttonGroup1.add(jRadioButton3);
        jRadioButton3.setText("Nepřidávat žadný štítek");
...
if(pickClosed){
    ...
    if(group.equals("Všechny kontakty")){
...
stitek = jTextField2.getText();
        ...
        sb.append("Importováno: "+imported+" kontaktů se štítkem "+stitek);

InfoDialog inf = new InfoDialog(mainWindow, true, "Zpráva o importu z Gmail", sb.toString());
inf.setVisible(true);
    ...
    jLabel4.setText("Nesprávné přihlašovací údaje");
